        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Visitor" md-sort-by="visitor">{{ item.visitor }}</md-table-cell>
              <md-table-cell md-label="Email" md-sort-by="email">{{ item.email }}</md-table-cell>
              <md-table-cell md-label="Contract" md-sort-by="contract">{{ item.nameContract }}</md-table-cell>
              <md-table-cell
...
export default {
  ...
  methods: {
    ...
    newGuest() {
      let ref = db.collection("guest").doc();
      router.push(`/guest/${ref.id}`);
    },
    handleEdit(item) {
      let id = item.id;
